      ...
      <main className="w-full max-w-5xl py-24 px-8 rounded-xl shadow-2xl bg-white/5 backdrop-blur-lg mt-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-blue-500 pl-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-3xl font-bold text-blue-300">Email Support</h2>
              </div>
            ...
            <div className="border-l-4 border-purple-500 pl-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-3xl font-bold text-purple-300">Response Times</h2>
              </div>
              <div className="space-y-3 text-gray-200">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-green-500 pl-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-3xl font-bold text-green-300">Support Categories</h2>
              </div>
            ...
            <div className="border-l-4 border-orange-500 pl-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-3xl font-bold text-orange-300">Connect With Us</h2>
              </div>
              <div className="space-y-3 text-gray-200">
                <div className="bg-white/5 rounded-lg p-4">
        ...
        <div className="border-l-4 border-pink-500 pl-6 mb-12">
          <div className="flex items-center mb-6">
            <Send className="w-6 h-6 mr-3 text-pink-400" />
            <h2 className="text-3xl font-bold text-pink-300">Quick Contact Form</h2>
          </div>
          <div className="bg-white/5 rounded-lg p-6">
            <p className="text-gray-300 mb-6">Need immediate assistance? Fill out this form and we&#39;ll get back to you as soon as possible.</p>
            ...
            <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all flex items-center">
