...
const Terms = () => (
  <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-purple-900 to-blue-900 text-white">
    ...
    <div className="flex-1 flex flex-col justify-center items-center">
      <main className="w-full max-w-5xl py-24 px-8 rounded-xl shadow-2xl bg-white/5 backdrop-blur-lg mt-12 mb-12">
        <div className="text-center mb-12">
          <Scale className="w-16 h-16 mx-auto mb-6 text-blue-400" />
          <h1 className="text-5xl font-extrabold mb-4 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent drop-shadow-lg">
            Terms of Service
          </h1>
        ...
        <div className="space-y-12">
          ...
          <div className="border-l-4 border-blue-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-blue-300">Acceptance of Terms</h2>
            </div>
          ...
          <div className="border-l-4 border-purple-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-purple-300">Use of Service</h2>
            </div>
            <div className="space-y-4 text-gray-200">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-200 mb-2">✅ Permitted Uses</h4>
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  <h4 className="font-semibold text-red-200 mb-2">❌ Prohibited Uses</h4>
                  <ul className="text-sm space-y-1">
          ...
          <div className="border-l-4 border-green-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-green-300">Data Responsibilities</h2>
            </div>
            <div className="space-y-4 text-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3 bg-white/5 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Only submit data and URLs you have the right to use and that comply with all laws.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 bg-white/5 rounded-lg p-4">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Do not submit personal, confidential, or sensitive information.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="border-l-4 border-orange-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-orange-300">Intellectual Property</h2>
            </div>
            <div className="space-y-4 text-gray-200">
              ...
              <div className="bg-white/5 rounded-lg p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-orange-200 mb-3">Your Content</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-orange-200 mb-3">Our Content</h4>
                    <ul className="text-sm space-y-2">
          ...
          <div className="border-l-4 border-red-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-red-300">Limitation of Liability</h2>
            </div>
            <div className="space-y-4 text-gray-200">
              ...
              <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-lg p-6 border border-red-500/30">
                <h4 className="font-semibold text-red-200 mb-3">Disclaimer</h4>
                <p className="text-sm mb-3">To the maximum extent permitted by applicable law, we exclude all representations, warranties, and conditions relating to our service and the use of this service.</p>
                <p className="text-sm">We will not be liable for any consequential, incidental, indirect, or special damages arising out of or in connection with your use of our service.</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-4 border-indigo-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-indigo-300">Service Access</h2>
            </div>
            <div className="space-y-4 text-gray-200">
          ...
          <div className="border-l-4 border-pink-500 pl-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-pink-300">Questions & Contact</h2>
            </div>
            <div className="space-y-4 text-gray-200">
              <div className="bg-white/5 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-pink-200 mb-3">Need Help with These Terms?</h3>
                <p className="mb-4">If you have any questions about these Terms of Service, please don&#39;t hesitate to contact us:</p>
